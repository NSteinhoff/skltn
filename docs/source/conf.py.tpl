...
import ${package}
${package}.project_no_spaces = '${project_no_spaces}'
...
latex_documents = [
    ('index', '${project_no_spaces}' + '.tex',
     '${project}' + ' Documentation', '${authors_string}',
     'manual'),
]
...
man_pages = [
    ('index', ${package}.__name__, '${project}' + ' Documentation',
     '${authors_string}', 1)
]
...
texinfo_documents = [
    ('index', '${project_no_spaces}',
     '${project}' + ' Documentation', '${authors_string}',
     '${project_no_spaces}', ${package}.__doc__, 'Miscellaneous'),
]
